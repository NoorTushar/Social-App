...
const PostCard = ({ post, refetch }) => {
   ...
   return (
      <div className="border flex flex-col max-w-xl p-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
         ...
         <div>
            ...
            <p className="text-sm dark:text-gray-600">{post.postDescription}</p>
         </div>
